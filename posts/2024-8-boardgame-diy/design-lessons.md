...
Jamey Stegmaier [about](https://stonemaiergames.com/about/staff/jamey-stegmaier/)
...
9. 第九步：游戏盲测
   ...
   ​        我会把桌游的电子版发给世界各地的游戏测试人员。或者各地的测试主管。这些测试主管会把游戏印刷出来，进行测试。而我们按他们花的时间付钱。这些人我都仔细检查过，确认过他们有出色的游戏测试能力。他们擅长让测试玩家做各种不同的事，尝试各种玩法。而且他们还能用书面形式进行回复，提出<font color=blue>建设性的反馈</font>。他们不会就说一句“你得改一下这个”或者“那个设计的不好”。他们会告诉我“当时在这种情况下发生了这个”、“然后因为那个，整的大家都很难受”。

   ​        从盲猜玩家那得到这种靠<font color=blue>案例和因果</font>驱动的反馈真的很有帮助。

10. 第十步：确认游戏完成度

    ​        我一般会对自己的游戏进行三到四次盲测。一般在第三或第四次测试时，我们会开始处理真正的细节部分：尽力调整平衡，整理规则，解决规则上的细节问题。

    ​        而且每次测试我都会让测试人员按十分制给游戏<font color=blue>打分</font>。当游戏的得分越来越高，最终达到8~9分的峰值时，我就会认为游戏基本已经可以拿去出版了。还有<font color=blue>平衡性</font>问题，比如一局游戏多长时间，最后谁赢了，如果是跑分游戏，各玩家的分数是否平衡。尤其是游戏里有非对称要素，就更要关注平衡问题了。

    ​	你还得参考现有的各种信息和自己的直觉，判断游戏有没有做好出版准备。

    

    对我而言这10个步骤的设计过程一般会花上10~18个月。
